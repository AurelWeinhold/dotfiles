# Generated by Powerlevel10k configuration wizard on 2021-04-05 at 15:42 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    #ix_shell               # nix shell (https://nixos.org/nixos/nix-pills/developing-with-nix-shell.html)
